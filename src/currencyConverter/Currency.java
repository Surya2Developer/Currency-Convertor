	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("INR", 76.64);
				break;
			case "Euro":
				...
				this.exchangeValues.put("INR", 80.45);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR", 96.04);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 78.33);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR", 11.59);
				break;
			case "Japanese Yen":
